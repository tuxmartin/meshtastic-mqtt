...
_CHANNEL_ROLE = _descriptor.EnumDescriptor(
  name='Role',
  full_name='meshtastic.Channel.Role',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_CHANNELSETTINGS = _descriptor.Descriptor(
  ...
  full_name='meshtastic.ChannelSettings',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='channel_num', full_name='meshtastic.ChannelSettings.channel_num', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='psk', full_name='meshtastic.ChannelSettings.psk', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='meshtastic.ChannelSettings.name', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='id', full_name='meshtastic.ChannelSettings.id', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='uplink_enabled', full_name='meshtastic.ChannelSettings.uplink_enabled', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='downlink_enabled', full_name='meshtastic.ChannelSettings.downlink_enabled', index=5,
...
_CHANNEL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='index', full_name='meshtastic.Channel.index', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='settings', full_name='meshtastic.Channel.settings', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='role', full_name='meshtastic.Channel.role', index=2,
